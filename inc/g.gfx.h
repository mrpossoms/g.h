...
static mesh<vertex::pos_uv_norm>& fullscreen_quad()
{
...
static void shadow(const framebuffer& shadow_map, const framebuffer& depth_map)
{
	...
	"{"
	"	float bias = 0.00006;"
	"	float depth = texture(u_depth_map, gl_FragCoord.xy / u_frame_dimensions).r - bias;"
	"	float shadowing = 0.0;"
...
static void blit(const framebuffer& fb)
{
