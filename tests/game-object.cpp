...
TEST
{
    ...
    assert(std::get<float>(foo.traits()["hp"]) == 99);
    assert(std::get<float>(foo.traits()["speed"]) == 1);
    ...
    assert(std::get<float>(foobar.traits()["hp"]) == 100);
    ...
    assert(std::get<float>(foobar1.traits()["hp"]) == 100);
